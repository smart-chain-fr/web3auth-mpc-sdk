...
// import {   EthereumSigningProviderConfig } from "@web3auth-mpc/ethereum-provider";
...
//       const param : EthereumSigningProviderConfig = {chainConfig}
//       console.log(param);
//       // const ethereumSigningProvider = new EthereumSigningProvider({config: param,});
